...
def new_request(request):
    ...
    data_request["date_delivery"] = verified_almacen(data_request["products"])
    ...
    create_cuenta_por_cobrar(
        {"id_request": id, "importe": generate_total_cost(data_request["products"]), "date_issue": date_request, "date_pay": None})
