                ...
                html.div({"id":"content"},
                    ...
                    html.div({"class":"container-fluid"},
                             ...
                             html.div({"class":"row d-flex"},
                                card_icome.card_income("primary","Ingresos (Mensuales)", 40.000, "fas fa-calendar fa-2x text-gray-300"),
                                card_icome.card_income("success","Ingresos (Anuales)", 215.000, "fas fa-dollar-sign fa-2x text-gray-300"),
                                card_pending_request.card_pending_request(50),
                                card_tasks.card_task(18)
                            ),
                            html.div({"class":"row"},
                                html.div({"class":"col-lg-6"},
                                html.div({"class":"card mb-4"},
                                      html.div({"class":"card-header"},"Default Card Example"),
                                      html.div({"class":"card-body"},
                                               "This card uses Bootstrap's default styling with no utility classes added. Global styles are the only things modifying the look and feel of this default card example.")
                                              ),
                                html.div({"class":"card mb-4"},
                                         html.div({"class":"card-header py-3"},
                                                  html.h6({"class":"m-0 font-weight-bold text-primary"},"Basic Card Example")
                                                  ),
                                        html.div({ "class":"card-body"},
                                ...
                                html.div({"class":"col-lg-6"},
                                         html.div({"class":"card shadow mb-4"},
                                                  ...
                                                  html.div({"class":"card-header py-3 d-flex flex-row align-items-center justify-content-between"},
                                                           html.h6({"class":"m-0 font-weight-bold text-primary"},"Dropdown Card Example"),
                                                           html.div({"class":"dropdown no-arrow"},
                                                                    html.a({"class":"dropdown-toggle", "href":"#", "role":"button", "id":"dropdownMenuLink", "data-toggle":"dropdown", "aria-haspopup":"true", "aria-expanded":"false"},
                                                                           html.i({"class":"fas fa-ellipsis-v fa-sm fa-fw text-gray-400"}),
                                                                           ),
                                                                    html.div({"class":"dropdown-menu dropdown-menu-right shadow animated--fade-in", "aria-labelledby":"dropdownMenuLink"},
                                                                             html.div({"class":"dropdown-header"},"Dropdown Header:"),
                                                                             html.a({"class":"dropdown-item", "href":"#"},"Action"),
                                                                             html.a({"class":"dropdown-item", "href":"#"},"Other Action"),
                                                  ...
                                                  html.div({"class":"card shadow mb-4"},
                                                           html.a({"href":"#collapseCardExample", "class":"d-block card-header py-3", "data-toggle":"collapse", "role":"button", "aria-expanded":"true","aria-controls":"collapseCardExample"},
                                                                  html.h6({"class":"m-0 font-weight-bold text-primary"},"Collapsable Card Example")
                                                                  ),
