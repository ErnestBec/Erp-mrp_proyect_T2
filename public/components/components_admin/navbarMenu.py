...
def Navbar():
    ...
    return html.ul(
        ...
        html.li(
            ...
            html.b(html.a({"href": "/Admin_Ordenes", "style": {"color": "black"}}, "Ordenes")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-card-list", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Solicitudes", "style": {"color": "black"}}, "Solicitudes")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-bag", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Catalogo", "style": {"color": "black"}}, "Catálogo")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-graph-up", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Pronostico", "style": {"color": "black"}}, "Pronóstico")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-cash", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Cuentas", "style": {"color": "black"}}, "Cuentas")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-database", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Almacenes", "style": {"color": "black"}}, "Almacenes")),
        ),
        html.li(
            {"className": "nav-item active", "style": {"marginLeft": "10%", "marginTop": "8%", "color": "#000000", "textAlign": "left"}},
            html.i({"className": "bi bi-inboxes", "style": {"fontSize": "20px", "marginRight": "8px"}}),
            html.b(html.a({"href": "/Admin_Racks", "style": {"color": "black"}}, "Racks")),
        ),
