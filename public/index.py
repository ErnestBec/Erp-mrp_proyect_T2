...
from pages import home_page, login_page, shopping, error_page, card_page, page_request, Tables_pages, utilities_others, charts, register, utilities_animation, dashboard,page_cuentas,utilities_color
